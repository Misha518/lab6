...
### Результаты
В результате работы программы у функции <p> <img src="http://www.sciweavers.org/tex2img.php?eq=f%28x_%7B1%7D%20%2C%20x_%7B2%7D%20%29%3D-3x_%7B1%7D%5E%7B2%7D%20-42%20x_%7B1%7D%20-2%20x_%7B2%7D%5E%7B2%7D-12%20x_%7B2%7D-158%20%20&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="f(x_{1} , x_{2} )=-3x_{1}^{2} -42 x_{1} -2 x_{2}^{2}-12 x_{2}-158  " width="367" height="25" /> </p> был найден экстремум в точке (-7;-3) (начальная точка (1;8)) за 38 итераций методом с точностью 0.00001. Ниже приведен рисунок.
